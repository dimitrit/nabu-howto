...
\twocolumn[\begin{@twocolumnfalse}
	\chapter{Freeing a stuck fan\hskip0.5cm\difficulty{1}}
	In many `New Old Stock' (NOS) NABU Personal Computers the fan either doesn't spin freely or is completely stuck. Several fixes have been suggested, including bending fan blades or filing down the fan tips. Following is a simpler and less destructive solution.
	\vskip1em
\end{@twocolumnfalse}]
...
\twocolumn[\begin{@twocolumnfalse}
	\chapter{Replacing the NABU Power Supply\hskip0.5cm\difficulty{4}}
