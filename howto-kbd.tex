...
\section{NABU (DIN-6) end of the cable}
\begin{enumerate}
...
\section{Adaptor (DB-9) end of the cable}
\begin{enumerate}
	\item Solder the pins on a \underline{female} DB-9 connector as shown in Figure \ref{fig:db9-kbd}.  Note that the pin numbers shown in the diagram are for the solder side of the connector.\\
