\twocolumn[\begin{@twocolumnfalse}
	\chapter{Making a Network Adaptor cable\hskip0.5cm\difficulty{3}}
...
\begin{figure}[h!]
	\begin{center}
		...
		\caption{DIN-5 male connector (solder side).}
		\label{fig:din5}
	\end{center}
\end{figure}
\begin{figure}[h!]
  \begin{center}
	...
	\caption{DB-9 female connector (solder side).$^2$}
	\label{fig:dsub9}
  \end{center}
\end{figure}
\begin{figure}
